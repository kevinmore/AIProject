...
namespace AIBehavior
{
	public class FollowState : BaseState
	{
		...
		{
			fsm.PlayAudio();
			lastSightedPlayerLocation = fsm.transform.position;
		}
		...
		protected override bool Reason(AIBehaviors fsm)
		{
			...
			sightedPlayer = fsm.GetClosestPlayerWithinSight(objectFinder.GetTransforms(), out closestPlayerDistance, false);
