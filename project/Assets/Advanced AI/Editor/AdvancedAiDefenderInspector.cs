...
[CustomEditor(typeof (AdvancedAiDefender))]
public class AdvancedAiDefenderInspector : Editor
{
    ...
    private void OnEnable()
    {
        ...
        so = serializedObject;
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "geni",
                                      ...
                                      new[] {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
                                      new[] {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
                                      new[] {false, false, false, false}, 0, "AdvancedAiDefender",
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "naviig",
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "lay", "layers",
        ...
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "attackM", "attackMode",
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "animigroup",
        ...
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "meattack",
                                      "meleeAttack", "Melee Attack", InspectorPlusVar.VectorDrawType.None, false, false,
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "raattack",
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "soundigroup", "sounds",
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "soundparoma",
                                      "soundsVolume",
