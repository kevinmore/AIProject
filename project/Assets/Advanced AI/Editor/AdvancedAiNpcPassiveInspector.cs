...
[CustomEditor(typeof (AdvancedAiNpcPassive))]
public class AdvancedAiNpcPassiveInspector : Editor
{
    ...
    private void OnEnable()
    {
        ...
        so = serializedObject;
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "generaling",
                                      ...
                                      new[] {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
                                      new[] {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
                                      new[] {false, false, false, false}, 0, "AdvancedAiNpcPassive",
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "navigat",
                                      "navigationParameters", "Navigation & Ranges",
        ...
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "fleem", "fleeMode",
                                      "Flee Mode", InspectorPlusVar.VectorDrawType.None, false, false, 0,
                                      new[] {false, false, false, false}, new[] {"", "", "", ""},
                                      new[] {false, false, false, false}, new[] {false, false, false, false},
                                      new[] {0, 0, 0, 0},
                                      new[]
        ...
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "animingroup",
        ...
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "soundingroup", "sounds",
                                      ...
                                      new Vector3(0.5f, 0.5f, 0f), false, true, "Tooltip", false, false, 0, 0, false, 70,
                                      "", false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None, 0, 0, false, 0, 0, true, "soundvolo",
                                      "soundsVolume",
