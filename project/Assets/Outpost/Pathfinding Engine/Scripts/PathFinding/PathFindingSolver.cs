...
namespace CS7056_AIToolKit
{
    ...
    {
        public static PathFindingSolver Instance; // Singleton of this class
        ...
        [HideInInspector]
        public NavWorld world = new NavWorld(10, 10, 10, 1); // The navigation world
        [HideInInspector]
        public float inclinationMax = 30; // Max inclination angle allowed (in degrees) 
        [HideInInspector]
        public bool diagonalConnection = true; // Whether linking two node diagonally
        [HideInInspector]
        public bool erode; // Whether erode the map
        [HideInInspector]
        public bool checkDynamicObstacle = false; // Whether check dynamic obstacle
        [HideInInspector]
        public bool agentAvoidance = true; // Whether the agents should avoid each other
        [HideInInspector]
        public float updateRateForDynamicObstacles = 0.2f;
